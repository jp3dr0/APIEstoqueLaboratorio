...
--
-- Host: 127.0.0.1
-- Generation Time: 11-Dez-2017 às 17:56
...
(6, NULL, 3, 'becker de vidro', NULL, 1000, NULL, 1),
...
,`qtd` int(11)
,`nome` varchar(45)
,`classificacaoReagente` int(11)
,`tamanhoVidraria` int(11)
,`valor` int(11)
,`unidade` int(11)
,`comentario` text
);
...
,`qtd` int(11)
,`nome` varchar(45)
,`classificacaoReagente` binary(0)
,`tamanhoVidraria` int(11)
,`valor` int(11)
,`unidade` int(11)
,`comentario` varchar(1000)
...
ALTER TABLE `operacao`
  ...
  ADD KEY `fk_Retirada_Usuario1_idx` (`Usuario_idUsuario`),
  ADD KEY `fk_Operacao_TipoOperacao1_idx` (`TipoOperacao_idTipoOperacao`),
  ADD KEY `fk_Operacao_Reagente` (`Reagente_idReagente`),
  ADD KEY `fk_Operacao_Vidraria` (`Vidraria_idVidraria`);
...
ALTER TABLE `reagente`
  ...
  ADD KEY `fk_Reagente_Classificacao1_idx` (`ClassificacaoReagente`),
  ADD KEY `fk_Reagente_Unidade` (`UnidadeReagente`);
...
ALTER TABLE `tipooperacao`
  ADD PRIMARY KEY (`idTipoOperacao`);
...
ALTER TABLE `usuario`
  ...
  ADD KEY `fk_Usuario_Nivel_idx` (`Nivel_idNivel`);
...
ALTER TABLE `vidraria`
  ...
  ADD KEY `fk_vidraria_Unidade` (`UnidadeVidraria`),
  ADD KEY `fk_vidraria_tamanho` (`tamanhoCapacidadeVidraria`);
...
--
ALTER TABLE `classificacao`
  MODIFY `idClassificacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `operacao`
  MODIFY `idOperacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `reagente`
--
ALTER TABLE `reagente`
  MODIFY `idReagente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;
...
--
ALTER TABLE `tipooperacao`
  MODIFY `idTipoOperacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `vidraria`
  MODIFY `idVidraria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=126;
...
--
ALTER TABLE `operacao`
  ADD CONSTRAINT `fk_Operacao_Reagente` FOREIGN KEY (`Reagente_idReagente`) REFERENCES `reagente` (`idReagente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Operacao_TipoOperacao1` FOREIGN KEY (`TipoOperacao_idTipoOperacao`) REFERENCES `tipooperacao` (`idTipoOperacao`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Operacao_Vidraria` FOREIGN KEY (`Vidraria_idVidraria`) REFERENCES `vidraria` (`idVidraria`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Retirada_Usuario1` FOREIGN KEY (`Usuario_idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `reagente`
--
ALTER TABLE `reagente`
  ADD CONSTRAINT `fk_Reagente_Classificacao1` FOREIGN KEY (`ClassificacaoReagente`) REFERENCES `classificacao` (`idClassificacao`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Reagente_Unidade` FOREIGN KEY (`UnidadeReagente`) REFERENCES `unidade` (`idUnidade`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `fk_Usuario_Nivel` FOREIGN KEY (`Nivel_idNivel`) REFERENCES `nivel` (`idNivel`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `vidraria`
--
ALTER TABLE `vidraria`
  ADD CONSTRAINT `fk_vidraria_Unidade` FOREIGN KEY (`UnidadeVidraria`) REFERENCES `unidade` (`idUnidade`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_vidraria_tamanho` FOREIGN KEY (`tamanhoCapacidadeVidraria`) REFERENCES `tamanho` (`idTamanho`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
