...
$app->any('/operacao[/{id}]', function ($request, $response, $args) {
	...
	$colunas = explode("`, `", "Reagente_idReagente`, `Vidraria_idVidraria`, `Usuario_idUsuario`, `TipoOperacao_idTipoOperacao`, `qtd`, `pendente, `img`, `comentario");

	$bindAdapter = "iiiiisss";
	...
	$controlador = new Controlador("Operação", "Operações", "operacao", $colunas, $bindAdapter);
